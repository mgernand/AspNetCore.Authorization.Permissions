namespace MadEyeMatt.AspNetCore.Identity.Permissions
{
		...
		where TTenant : class, ITenant
	{
		...
		public virtual IQueryable<TTenant> Tenants
		{
			get
			{
				IQueryableTenantStore<TTenant> queryableStore = this.Store as IQueryableTenantStore<TTenant>;
		...
		public virtual async Task<IdentityResult> SetTenantNameAsync(TTenant tenant, string name)
		{
			...
			await this.Store.SetTenantNameAsync(tenant, name, this.CancellationToken);
			await this.UpdateNormalizedTenantNameAsync(tenant);
