namespace MadEyeMatt.AspNetCore.Identity.Permissions
{
	...
	public static class ServiceCollectionExtensions
	{
			...
			where TPermission : class
		{
			...
			services.TryAddScoped<PermissionManager<TUser>>();
			...
			return new PermissionIdentityBuilder(typeof(TUser), typeof(TPermission), builder.Services);
		}
			...
			where TPermission : class
		{
			...
			return new PermissionIdentityBuilder(typeof(TTenant), typeof(TUser), typeof(TPermission), builder.Services);
		}
    }
}
