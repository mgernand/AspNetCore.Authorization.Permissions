namespace SamplePermissions
{
	...
	public class ApplicationDbContext : MadEyeMatt.AspNetCore.Authorization.Permissions.Identity.EntityFrameworkCore.IdentityPermissionsDbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<MadEyeMatt.AspNetCore.Authorization.Permissions.Identity.PermissionsIdentityTenant<string>>(entity => entity.ToTable("Tenants"));
			builder.Entity<IdentityUserClaim<string>>(entity => entity.ToTable("UserClaims"));
			builder.Entity<IdentityUserLogin<string>>(entity => entity.ToTable("UserLogins"));
			builder.Entity<IdentityRoleClaim<string>>(entity => entity.ToTable("RoleClaims"));
			builder.Entity<IdentityUserToken<string>>(entity => entity.ToTable("UserTokens"));
			builder.Entity<MadEyeMatt.AspNetCore.Authorization.Permissions.Identity.IdentityTenantRole<string>>(entity => entity.ToTable("TenantRoles"));
		}
	}
}
